...
export const getHomePageData = async () => {
    ...
    const getData = {
        ...
        sectionsRequirement: ["NewArrivals", "MostPopular", "MostPopular", "MostPopular", "MostPopular"],
        sectionsName: ["AllProducts", "Ноутбуки", "Смартфоны", "Планшеты", "Компьютеры, серверы"],
        sort: -1,
        amountItems: 10
    };
    const fetchData = {
